...
const CompanyVipPackagesBought = lazy(() => import('@/pages/company/vipPackage/VipPackageBought'));
...
const PrivateRoutes: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: ROUTE_PATH.COMPANY.VIP_PACKAGE.BOUGHT, element: <CompanyVipPackagesBought /> },
