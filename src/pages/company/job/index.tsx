...
const index = () => {
    ...
    const { getJobsCurrentCompany } = useJobService();
    ...
    return (
        <div className="space-y-6 dark:bg-black dark:text-white">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Button onClick={() => navigate(ROUTE_PATH.COMPANY.JOBS.CREATE)} className="cursor-pointer bg-gradient-to-r from-cyan-600 to-teal-600 text-white shadow-lg hover:from-cyan-700 hover:to-teal-700">
